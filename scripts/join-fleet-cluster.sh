...
# The redirect is the caller's, not sudo's, and that is correct here: the
# preseed was written by this script as the caller and root does not need to
# open it. SC2024 assumes the opposite case.
